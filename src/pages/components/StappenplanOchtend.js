...
function StappenplanOchtend() {
  const [stappenLijst, setStappenLijst] = useState([
    ...
    { id: 4, text: "Wassen 🚿 – Neem een douche, bad of was je aan de lavabo.", completed: false },
    ...
    <div className={`stappenplan-container ${completed ? 'completed' : ''}`}>
      <div className="header" style={{ backgroundColor: 'white' }}>
        <div className="title-container">
          <h1 className="title" style={{ fontFamily: 'Genty Sans, sans-serif', fontSize: '40px', color: 'var(--app)', margin: 3 }}>Ochtendroutine</h1>
